...
## Project Structure
    ...
    ├── horse_training_trac_32220  # Django project configurations
...
1. Clone this repo and `cd horse_training_trac_32220`
...
2. Clone this repo and `cd horse_training_trac_32220`
